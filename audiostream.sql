...
-- -----------------------------------------------------
-- Table `audiostream`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `audiostream`.`users` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `audiostream`.`playlist` (
  ...
  PRIMARY KEY (`id`, `creation_user_id`),
  INDEX `fk_playlist_users1_idx` (`creation_user_id` ASC),
  INDEX `uk_playlist_user_name` (`name` ASC, `creation_user_id` ASC),
  CONSTRAINT `fk_playlist_users1`
    FOREIGN KEY (`creation_user_id`)
    REFERENCES `audiostream`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `audiostream`.`playlist_song` (
  ...
  `playlist_creation_user_id` INT NOT NULL,
  PRIMARY KEY (`id`, `playlist_id`, `playlist_creation_user_id`),
  INDEX `fk_playlist_song_next_idx` (`next_playlist_song_id` ASC),
  INDEX `fk_playlist_song_playlist1_idx` (`playlist_id` ASC, `playlist_creation_user_id` ASC),
  ...
  CONSTRAINT `fk_playlist_song_playlist1`
    FOREIGN KEY (`playlist_id` , `playlist_creation_user_id`)
    REFERENCES `audiostream`.`playlist` (`id` , `creation_user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_playlist_song_previous`
